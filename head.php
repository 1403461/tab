...
<head>
	...
	.my-head{
		...
		border-radius: 10px 10px 0px 0px;
		color: white;
		background-color: rgb(140,34,61);
		font-family:"Microsoft 宋体",宋体,"MicrosoftJhengHei",华文细黑,STHeiti,MingLiu
		color: #5f5a5a;
		/*color: white;*/
	}
...
<body>
	<div class="sui-container" >
		<div class="my-head"><a href="index.php" id="xwlj">北京网络职业学院学生管理系统 V1.0</a></div><div class="userinfo">欢迎<span><?php echo empty($_SESSION['usname'])? "尊敬的会员":$_SESSION['usname']; ?></span>登录&nbsp;&nbsp;<a href="login-out.php">退出</a></div>
